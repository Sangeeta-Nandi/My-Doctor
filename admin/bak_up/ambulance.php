...
<body>
<form method="post" action="ambulance.php" enctype="multipart/form-data" accept-charset="utf-8">
  <div id="header">
          ...
          <div class="row principal_msg"> <!-- Principal Massage Start-->
            <div class="col-md-12">
              <div class="panel panel-primary">
                <div style="font-weight: bold; font-size: 18px; text-align:center;" class="panel-heading">Ambulance Info Entry</div>
                <div class="panel-body"> 
                  <!--table-->
                  <div class="row">
                    <div class="form-group">
                      <label for="hname" class="col-sm-4 control-label">Ambulance Provider Name:</label>
                      <div class="col-sm-6">
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table">
                                ...
                                <tr style="background: #02204d none repeat scroll 0 0; color: #fff;">
								    <td><strong>Ambulance Provider Name</strong></td>
							   ...
							   $view_priciple_msg_query=mysql_query("select * FROM ambulance  order by 1 DESC LIMIT 50");
							  while( $row = mysql_fetch_array($view_priciple_msg_query)){
                                ...
                                <tr>
                                    ...
                                    <td><a href="edit_ambulance.php?id=<?php echo $id;?>">Edit</a></td>
...
if(isset($_POST['submit'])){
	...
	//	move_uploaded_file($image_tmp,"../news_file/$post_image");
		$insert_query = "insert into ambulance(ambulance_id,ambulance_service_name,ambulance_city,ambulance_address,ambulance_phone,ambulance_website) values ('','$post_hname','$post_city','$post_address','$post_phone','$post_hlink')";
