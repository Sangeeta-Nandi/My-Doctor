...
<body>
<form method="post" action="article.php" enctype="multipart/form-data" accept-charset="utf-8">
		<div id="header">
                        ...
                        <div class="panel-body">
                            ...
                            <div>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                          <input name="type" type="text" class="form-control" id="inputEmail3" placeholder="Post Writer">
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                          <input name="articlesource" type="text" class="form-control" id="inputEmail3" placeholder="article source">
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                        <textarea class="form-control" rows="10" name="writer" ></textarea>
                                        </div>
                                      </div>
...
if(isset($_POST['submit'])){
	 ...
	 $article_source=$_POST['articlesource'];
	 $date = date("Y-m-d  H:i:s");
	
if($post_title=='' && ($post_link=='' or $post_writer=='') &&  $art_type==''){
	...
	//	move_uploaded_file($image_tmp,"../news_file/$post_image");
		$insert_query = "insert into article(ArticleID,ArticleTitle,ArticleWriter,ArticleType,ArticleDownloadLink,ArticleSource,ArticlePostDate) 
		values ('','$post_title','$post_writer','$art_type','$post_link','$article_source','$date')";
