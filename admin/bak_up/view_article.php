...
<body>
<form class="form-horizontal" action="view_article.php" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
		<div id="header">
...
<div class="row principal_msg"> <!-- Principal Massage Start-->
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div style="font-weight: bold; font-size: 18px;" class="panel-heading">View Article Information</div>
                        <div class="panel-body">
                            ...
                            <table class="table">
                                ...
                                <tr style="background: #02204d none repeat scroll 0 0; color: #fff;">
									...
									<td><strong>Article Writer</strong></td>
							   ...
							   $view_priciple_msg_query=mysql_query("select * from article order by ArticleID DESC LIMIT 50");
							  while( $row = mysql_fetch_array($view_priciple_msg_query)){
							    $id = $row['ArticleID'];
								$title = $row['ArticleTitle'];
								$Article_Writer = $row['ArticleWriter'];
								...
								$ArticlePDate = $row['ArticlePostDate'];
								$table = "article";
                                ...
                                <tr>
									...
									<td><?php echo $Article_Writer; ?></td>
									 <td><?php echo $Link; ?></td>
									<td><?php echo $ArticleSource; ?></td>
									
                                    <td><?php echo $ArticlePDate; ?></td>
