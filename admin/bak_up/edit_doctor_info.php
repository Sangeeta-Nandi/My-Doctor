              ...
              <div class="panel-body"> 
                ...
                <div>
                  <?php
								...
								if(isset($_GET['id'])){
								 $page_id = $_GET['id'];
							   $view_priciple_msg_query=mysql_query("select * FROM doctor_info  where doctor_id='$page_id'");
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <img src="department/<?php echo $d_image;?>" width="130" height="130" alt="" border="0">
...
if($doctorName=='' &&  $post_image==''){
	...
	exit();
       ...
       $uploadfile = $uploaddir . basename($_FILES['image']['name']);
		...
		$update_query = "update doctor_info set doctor_name='$doctorName' ,d_address='$post_pAddress',doctor_phone='$post_pPhone',d_mobile='$post_pMobile',city='$post_city',doctor_eperience='$post_experience',d_image='$post_image' where d_dept_id = '$pageid'";
		mysql_query($update_query);
		
		}
		else
		{
			$update_query = "update doctor_info set doctor_name='$doctorName' ,d_address='$post_pAddress',doctor_phone='$post_pPhone',d_mobile='$post_pMobile',city='$post_city',doctor_eperience='$post_experience',
