...
<body>
<form method="post" action="edit_branch.php" enctype="multipart/form-data" accept-charset="utf-8">
  <div id="header">
 ...
 $view_msg_query=mysql_query("select b.branch_id,b.branch_name,c.company_name,branch_type  from d_branch b INNER JOIN d_company c ON
b.company_id=c.company_id where b.branch_id ='$page_id'");
							     $row = mysql_fetch_assoc($view_msg_query);
							    
								
								$branchID = $row['branch_id'];
								$branchName = $row['branch_name'];
								$branType=$row['branch_type'];
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <input name="branname" type="text" class="form-control" id="inputEmail3" value="<?php echo $branchName; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <input name="comname" type="text" class="form-control" id="inputEmail3" value="<?php echo $compname; ?>">
                    </div>
                  </div>
                  <div class="form-group">
...
if($companyName=='' &&  $companyType==''){
	...
	exit();
		...
		$update_query = "update d_branch set branch_name='$branchName' where branch_id = '$pageid'";
