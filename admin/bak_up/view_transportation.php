...
<div class="row principal_msg"> <!-- Principal Massage Start-->
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div style="font-weight: bold; font-size: 18px;" class="panel-heading">Video List</div>
                        <div class="panel-body">
                            ...
                            <table class="table">
							   ...
							   $view_priciple_msg_query=mysql_query("select * from video order by VideoID DESC LIMIT 50");
							  while( $row = mysql_fetch_array($view_priciple_msg_query)){
                                ...
                                <tr>
                                    ...
                                    <td><a href="edit_transportation.php?id=<?php echo $id; ?>">Edit</a></td>
