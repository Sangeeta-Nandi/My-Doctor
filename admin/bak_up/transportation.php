...
<body>
<form method="post" action="transportation.php" enctype="multipart/form-data" accept-charset="utf-8">
  <div id="header">
              ...
              <div class="panel-body"> 
                ...
                <div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <textarea class="form-control" rows="13" name="sub" placeholder="Subject Detail here"></textarea>
                    </div>
                  </div>
                  <div class="form-group">
...
if($post_title=='' && ($post_link=='' or $post_sub=='') &&  $msg_lecturer==''){
	...
	//	move_uploaded_file($image_tmp,"../news_file/$post_image");
		$insert_query = "insert into video(VideoID,VideoTitle,VideoLecturer,VideoTitleLink,VideoSubject,PostDate) values ('','$post_title','$msg_lecturer','$post_link','$post_sub','$date')";
