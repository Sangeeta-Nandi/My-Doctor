...
<body>
<form method="post" action="edit_book.php" enctype="multipart/form-data" accept-charset="utf-8">
		<div id="header">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							...
							<?php
							   ...
							   if(isset($_GET['id'])){
								   $page_id = $_GET['id'];
								   $view_priciple_msg_query=mysql_query("select * from books where 	BookID ='$page_id'");
								...
								$bookPublisher = $row['BookPublisher'];
								   ...
								   <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                          <input name="booktype" type="text" class="form-control" id="inputEmail3" value="<?php echo $booktype; ?>">
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                        <textarea class="form-control" rows="13" name="bookpublisher"><?php echo $bookPublisher; ?></textarea>
                                        </div>
                                      </div>
...
if(isset($_POST['submit'])){
	 ...
	 $post_BookType = $_POST['booktype'];
	 $link_edit = $_POST['link'];
	 $bookpublisherPost = $_POST['bookpublisher'];
...
if($post_title=='' && ($post_lecturer=='' or $link=='') &&  $msg_from==''){
	...
	exit();
			  ...
			  if($post_image=='')
			  {
				   $update_query1 = "update books set         BookTitle='$post_title',BookType='$post_BookType',BookDownLoadLink='$link_edit',BookPublisher='$bookpublisherPost'
				   ,PostDate='$date' where BookID = '$page_id'";
			  mysql_query($update_query1);
					  ...
					  echo "<script>window.open('view_book.php','_self')</script>";
			  ...
			  $update_query = "update books set BookTitle='$post_title',BookType='$post_BookType',BookDownLoadLink='$link_edit',BookPublisher='$bookpublisherPost',	BookImage ='$post_image',PostDate='$date' where BookID = '$page_id'";
