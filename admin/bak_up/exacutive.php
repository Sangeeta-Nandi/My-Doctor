...
<body>
<form class="form-horizontal" action="exacutive.php" method="post" enctype="multipart/form-data" accept-charset="utf-8">
		<div id="header">
...
<div class="row principal_msg"> <!-- Principal Massage Start-->
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div style="font-weight: bold; font-size: 18px;" class="panel-heading">Exacutive Body Panel</div>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                           <select class="form-control" name="type" required>
                                              <option>Select Designation Option</option>
                                              <option value="Chairman">Chairman</option>
                                              <option value="Vice-Chairman"> Vice-Chairman </option>
                                              <option value="MD">Managing Director</option>
                                              <option value="DMD">Deputy Managing Director </option                                              <option value="Director">Director</option>
                                              </select>
                                        </div>
                                      </div>
