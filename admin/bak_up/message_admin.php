...
if($post_title=='' && ($post_msg=='' or $post_image=='') &&  $msg_from==''){
	...
	exit();
		...
		if($msg_from=='Principal' or $msg_from=='Vice-Principal' or $msg_from=='Secretary')
		{
		move_uploaded_file($image_tmp,"../news_file/$post_image");
		$insert_query = "insert into message(id,title,content,type,image,date) values ('','$post_title','$post_msg','$msg_from','$post_image','$date')";
