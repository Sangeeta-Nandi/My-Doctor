              ...
              <div class="panel-body"> 
                ...
                <div>
                  <?php
								 ...
								 $view_priciple_msg_query=mysql_query("select * from govt_hospital where gov_hs_id ='$page_id'");
...
if($hosp_name=='' &&  $hosp_city=='' && $hosp_address=='' &&  $hosp_phone==''){
	...
	exit();
		...
		$update_query = "update govt_hospital set gov_hs_name='$hosp_name',gov_hs_city='$hosp_city',gov_hs_address='$hosp_address',gov_hs_phone='$hosp_phone', gov_hs_website='$hosp_weblink' where gov_hs_id = '$pageid'";
