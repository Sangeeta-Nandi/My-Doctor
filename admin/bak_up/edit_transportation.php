...
<body>
<form method="post" action="edit_transportation.php" enctype="multipart/form-data" accept-charset="utf-8">
		<div id="header">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							...
							<?php
							   ...
							   if(isset($_GET['id'])){
								   $page_id = $_GET['id'];
								   $view_priciple_msg_query=mysql_query("select * from video where VideoID ='$page_id'");
							    $row = mysql_fetch_array($view_priciple_msg_query);
							    
								
								$title = $row['VideoTitle'];
								$lecture = $row['VideoLecturer'];
								$Link = $row['VideoTitleLink'];
								
								$Subject = $row['VideoSubject'];
								   ...
								   <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">Video Title:</label>
                                        <div class="col-sm-6">
                                          ...
                                          <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">Video Lecturer:</label>
                                        <div class="col-sm-6">
                                       ...
                                       <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">Video Link:</label>
                                        <div class="col-sm-6">
                                      ...
                                      <div class="form-group">
                                        <label for="inputMessage" class="col-sm-4 control-label">Subject:</label>
                                        <div class="col-sm-6">
                                        <textarea class="form-control" rows="13" name="subject"><?php echo $Subject; ?></textarea>
                                        </div>
                                      </div>
...
if($post_title=='' && ($post_lecturer=='' or $link=='') &&  $msg_from==''){
	...
	exit();
		...
		$update_query = "update video set VideoTitle='$post_title',VideoLecturer='$post_lecturer',VideoTitleLink='$link',VideoSubject='$Subject',	PostDate='$date' where VideoID = '$page_id'";
	...
	echo "<script>window.open('view_transportation.php','_self')</script>";
