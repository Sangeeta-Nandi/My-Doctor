...
<body>
<form method="post" action="edit_foreign_hospital.php" enctype="multipart/form-data" accept-charset="utf-8">
  <div id="header">
              ...
              <div class="panel-body"> 
                ...
                <div>
                  <?php
								 ...
								 $view_priciple_msg_query=mysql_query("select * from foreign_hospital where fore_hs_id ='$page_id'");
                  ...
                  <div class="form-group">
                    <label for="inputEmail3" class="col-sm-4 control-label">Foreign Hospital Name:</label>
                    <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    <label for="inputEmail3" class="col-sm-4 control-label">Continent:</label>
                    <div class="col-sm-6">
...
if($hosp_name=='' &&  $hosp_city=='' && $hosp_address=='' &&  $hosp_phone==''){
	...
	exit();
		...
		$update_query = "update foreign_hospital set fore_hs_name='$hosp_name',fore_hs_city='$hosp_city',fore_hs_continent='$hosp_address',fore_hs_weblink='$hosp_weblink' where fore_hs_id = '$pageid'";
