...
<body>
<form method="post" action="audio.php" enctype="multipart/form-data" accept-charset="utf-8">
		<div id="header">
                        ...
                        <div class="panel-body">
                            ...
                            <div>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                          <input name="title" type="text" class="form-control" id="inputEmail3" placeholder="Post title">
                                            ...
                                            <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">Lecturer:</label>
                                        <div class="col-sm-6">
                                          <input name="lecturer" type="text" class="form-control" id="inputEmail3" placeholder="Post Lecturer">
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                          <input name="link" type="text" class="form-control" id="inputEmail3" placeholder="Post link">
                                        </div>
                                      </div>
                                      
                                      
                                       <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">Streaming Link:</label>
                                        <div class="col-sm-6">
                                          <input name="streamlink" type="text" class="form-control" id="inputEmail3" placeholder="Streaming link">
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                        <textarea class="form-control" rows="13" name="sub" ></textarea>
                                        </div>
                                      </div>
...
if(isset($_POST['submit'])){
	 ...
	 $post_sub = $_POST['sub'];
	 $msg_lecturer = $_POST['lecturer'];
	 $post_link = $_POST['link'];
	 $streaming_link=$_POST['streamlink'];
	 $date = date("Y-m-d  H:i:s");
	
if($post_title=='' && ($post_link=='' or $post_sub=='') &&  $msg_lecturer==''){
	...
	//	move_uploaded_file($image_tmp,"../news_file/$post_image");
		$insert_query = "insert into audio(AudioID,AudioTitle,AudioSubject,AudioLecturer,AudioDownloadLink,AudioStremingLink,AudioPostDate) values ('','$post_title','$post_sub','$msg_lecturer','$post_link','$streaming_link','$date')";
