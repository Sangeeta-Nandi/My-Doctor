...
<body>
<form class="form-horizontal" action="teachers_admin.php" method="post" enctype="multipart/form-data" accept-charset="utf-8">
		<div id="header">
...
<div class="row principal_msg"> <!-- Principal Massage Start-->
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div style="font-weight: bold; font-size: 18px;" class="panel-heading">Teachers Admin Panel</div>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                          <select class="form-control" name="status" required>
                                              ...
                                              <option value="running">Running Teacher</option>
...
if(isset($_POST['submit'])){
		 ...
		 $insert_query="INSERT INTO `teacher_info`(`id`, `FullName`, `FatherName`, `MotherName`, `BirthDate`, `Gender`, `Religion`, `image`, `usertype`, `subject`,`Designation`, `date`) 
		  VALUES ('$id','$name','$gardian','$mother','$bof','$gender','$religion','$post_image','$status','$subject','$Designation','$date')";
