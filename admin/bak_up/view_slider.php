...
<div class="row principal_msg"> <!-- Principal Massage Start-->
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div style="font-weight: bold; font-size: 18px;" class="panel-heading">view slider Admin Panel</div>
                        <div class="panel-body">
                            ...
                            <table class="table">
							   ...
							   $view_priciple_msg_query=mysql_query("select * from slider order by id DESC LIMIT 50");
							  while( $row = mysql_fetch_array($view_priciple_msg_query)){
                                ...
                                <tr>
									...
									<td><?php echo $type; ?></td>
									<td><img src="../news_file/<?php echo $image; ?>" style="height: 100px; width: 200px" border="0"></td>
