...
<body>
<form method="post" action="edit_audio.php" enctype="multipart/form-data" accept-charset="utf-8">
		<div id="header">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							...
							<?php
							   ...
							   if(isset($_GET['id'])){
								   $page_id = $_GET['id'];
								   $view_priciple_msg_query=mysql_query("select * from audio where AudioID ='$page_id'");
								...
								$StreamLink = $row['AudioStremingLink'];
								   ...
								   <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">Audio Title:</label>
                                        <div class="col-sm-6">
                                          ...
                                          <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">Audio Lecturer:</label>
                                        <div class="col-sm-6">
                                          <input name="lecturer" type="text" class="form-control" id="inputEmail3" value="<?php echo $lecture; ?>">
                                        </div>
                                      </div>
                                       ...
                                       <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">Audio Link:</label>
                                        <div class="col-sm-6">
                                       ...
                                       <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">Audio Streaming Link:</label>
                                        <div class="col-sm-6">
                                          <input name="Streamlink" type="text" class="form-control" id="inputEmail3" value="<?php echo $StreamLink; ?>">
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                        <label for="inputMessage" class="col-sm-4 control-label">Audio Subject:</label>
                                        <div class="col-sm-6">
                                        <textarea class="form-control" rows="13" name="subjectp"><?php echo $Subject; ?></textarea>
                                        </div>
                                      </div>
...
if(isset($_POST['submit'])){
	 ...
	 $post_lecturer = $_POST['lecturer'];
	 $linkP = $_POST['link'];	
	 $SubjectPost = $_POST['subjectp'];	 
	 $treamlinkp = $_POST['Streamlink'];
	 
	 $date = date("Y-m-d  H:i:s");
	// $post_image= $_FILES['image']['name'];
//	 $image_tmp= $_FILES['image']['tmp_name'];
if($post_title=='' && ($post_lecturer=='' or $link=='') &&  $Subject==''){
	...
	exit();
		...
		$update_query = "update audio set AudioTitle='$post_title',AudioSubject='$SubjectPost',AudioLecturer='$post_lecturer',
		AudioDownloadLink='$linkP',AudioStremingLink='$treamlinkp',AudioPostDate='$date' where AudioID = '$page_id'";
