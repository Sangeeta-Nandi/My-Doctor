...
<body>
<form method="post" action="private_hospital.php" enctype="multipart/form-data" accept-charset="utf-8">
  <div id="header">
          ...
          <div class="row principal_msg"> <!-- Principal Massage Start-->
            <div class="col-md-12">
              <div class="panel panel-primary">
                <div style="font-weight: bold; font-size: 18px; text-align:center;" class="panel-heading">Private Hospital Info Entry</div>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table">
							   ...
							   $query="select * FROM private_hospital  order by 1 DESC LIMIT 50";
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $website; ?></td>
                                       ...
                                       <td><img src="img/<?php echo $p_image;?>" width="100" height="100" alt="" border="0"></td>
                                    <td><a href="edit_private_hospital.php?id=<?php echo $id;?>">Edit</a></td>
...
if(isset($_POST['submit'])){
	 ...
	 $image_tmp= $_FILES['image']['tmp_name'];
		...
		$insert_query = "insert into private_hospital(pri_hs_id,pri_hs_name,pri_hs_address,pri_hs_city,pri_hs_phone,pri_hs_website,pri_hs_image) values ('','$post_hname','$post_address','$post_city','$post_phone','$post_hlink','$post_image')";
