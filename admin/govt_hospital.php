							   ...
							   $query="select * FROM govt_hospital  order by 1 DESC LIMIT 50";
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $website; ?></td>
                                      <td><img src="img/<?php echo $g_image;?>" width="100" height="100" alt="" border="0"></td>
...
if(isset($_POST['submit'])){
	 ...
	 $image_tmp= $_FILES['image']['tmp_name'];
		...
		$insert_query = "insert into govt_hospital(gov_hs_id,gov_hs_name,gov_hs_city,gov_hs_address,gov_hs_phone,gov_hs_website,gov_hs_image) values ('','$post_hname','$post_city','$post_address','$post_phone','$post_hlink','$post_image')";
