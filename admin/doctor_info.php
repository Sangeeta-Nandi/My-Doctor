...
<form method="post" action="doctor_info.php" enctype="multipart/form-data" accept-charset="utf-8">
                ...
                <div class="panel-body"> 
                  ...
                  <div>
                    <div class="form-group">
                      ...
                      <div class="form-group">
                      <label for="companytype" class="col-sm-4 control-label">Doctor Degree:</label>
                      <div class="col-sm-6">
                        <input name="Degree" type="text" class="form-control" id="inputEmail3" placeholder="Enter doctor Degree">
                      </div>
                    </div>
  ...
  //  $mysqli = new mysqli("localhost","mydoctor_dbdoc","24434mydoctor","mydoctor_db");
...
?>
					...
					<div class="form-group">
                      <label for="cname" class="col-sm-4 control-label">Designation:</label>
                      <div class="col-sm-6">
                        <input name="Designation" type="text" class="form-control" id="inputEmail3" placeholder="Enter Designation">
                      </div>
                    </div>
					<div class="form-group">
                      <label for="cname" class="col-sm-4 control-label">Organization:</label>
                      <div class="col-sm-6">
                        <input name="Organization" type="text" class="form-control" id="inputEmail3" placeholder="Enter Organization">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputMessage" class="col-sm-4 control-label">Chamber Address:</label>
                      <div class="col-sm-6">
                        <input type="text" class="form-control" rows="13" name="chamberAddress" placeholder="Enter Chamber Address">
                      </div>
                    </div>
                    <div class="form-group">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input name="docexperience" type="text" class="form-control" id="inputEmail3" placeholder="Enter Experience">
                      </div>
                    </div>
              ...
              <div class="panel-body"> 
                ...
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <?php  
							   include("include/connect.php");
							   $query="select * FROM doctor_info order by 1 DESC";
...
if(isset($_POST['submit'])){
	 ...
	 $post_organization = $_POST['Organization'];
...
if($post_doctor==''  &&  $post_type==''){
	...
	exit();
		...
		//$uploaddir = '/home/mydoctor/public_html/admin/department/';
		$uploaddir = 'C:/xampp/htdocs/mydoctor_final2/admin/department/';
		
        $uploadfile = $uploaddir . basename($_FILES['image']['name']);
		move_uploaded_file($_FILES['image']['tmp_name'], $uploadfile);
		
		$insert_query = "insert into doctor_info(doctor_id,doctor_name,company_id,branch_id,d_dept_id,d_address,doctor_phone,d_mobile,doctor_eperience,city,doctor_degree,doctor_designation,doctor_organization,d_image) values ('','$post_doctor','$ddl_company','$ddl_branch','$post_dept','$chamberAddress','$post_docphone','$post_docMobile','$docexperience','$post_city','$post_degree','$post_designation','$post_organization','$post_image')";
