...
<form method="post" action="edit_branch.php" enctype="multipart/form-data" accept-charset="utf-8">
 ...
 $query="select b.branch_id,b.branch_name,c.company_name,branch_type  from d_branch b INNER JOIN d_company c ON b.company_id=c.company_id where b.branch_id =$page_id";
