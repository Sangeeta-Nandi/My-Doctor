...
<body>
<form method="post" action="edit_diagnostic.php" enctype="multipart/form-data" accept-charset="utf-8">
  <div id="header">
              ...
              <div class="panel-body"> 
                ...
                <div>
                  <?php
								 ...
								 $query="select * from diagnostic where id =$page_id";
                  ...
                  <div class="form-group">
                    <label for="inputEmail3" class="col-sm-4 control-label">Diagnostic Name:</label>
                    <div class="col-sm-6">
...
if($hosp_name=='' &&  $hosp_city=='' && $hosp_address=='' &&  $hosp_phone==''){
	...
	exit();
		...
		$update_query = "update diagnostic set provider_name='$hosp_name',city='$hosp_city',address='$hosp_address',phone='$hosp_phone', website='$hosp_weblink' where id = '$pageid'";
