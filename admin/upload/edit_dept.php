                ...
                <div class="panel-body"> 
                  ...
                  <div>
                    <?php
								 ...
								 $query="select * from  d_department where d_dept_id =$page_id";
...
if($deptName=='' &&  $post_image==''){
	...
	exit();
       ...
       $uploadfile = $uploaddir . basename($_FILES['image']['name']);
		...
		$update_query = "update d_department set dept_name='$deptName',dept_title='$updat_title',d_depart_image='$post_image' 
		where d_dept_id =$pageid";
