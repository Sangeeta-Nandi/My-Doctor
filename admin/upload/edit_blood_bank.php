...
<body>
<form method="post" action="edit_blood_bank.php" enctype="multipart/form-data" accept-charset="utf-8">
  <div id="header">
              ...
              <div class="panel-body"> 
                ...
                <div>
                  <?php
								 ...
								 $query="select * from blood_bank where blood_bank_id =$page_id";
...
if($hosp_name=='' &&  $hosp_city=='' && $hosp_address=='' &&  $hosp_phone==''){
	...
	exit();
		...
		$update_query = "update blood_bank set blood_bank_name='$hosp_name',bb_city='$hosp_city',bb_address='$hosp_address',bb_phone='$hosp_phone', bb_website='$hosp_weblink' where blood_bank_id = '$pageid'";
