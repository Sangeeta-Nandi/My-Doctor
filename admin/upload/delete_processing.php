...
<div class="row principal_msg"> <!-- Principal Massage Start-->
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div style="font-weight: bold; font-size: 18px;" class="panel-heading">Video Delete Admin Panel</div>
                            ...
                            <div>
							   ...
							   if(isset($_GET['id'])&&isset($_GET['table'])){
								   $page_id = $_GET['id'];
									...
									mysql_query("delete from $table where company_id='$page_id'");
								    ...
								    else if($table=='d_branch')
									{
									  ...
									  mysql_query("delete from $table where branch_id='$page_id'");
									...
									else if($table=='d_department')
									{
									  ...
									  mysql_query("delete from $table where d_dept_id='$page_id'");
									...
									else if($table=='govt_hospital')
									{
										...
										mysql_query("delete from $table where gov_hs_id='$page_id'");
									...
									else if($table=='blood_bank')
									{
										...
										mysql_query("delete from $table where blood_bank_id='$page_id'");
									...
									else if($table=='ambulance')
									{
										...
										mysql_query("delete from $table where ambulance_id='$page_id'");
									...
									else if($table=='foreign_hospital')
									{
										...
										mysql_query("delete from $table where fore_hs_id='$page_id'");
									...
									else if($table=='d_test_name')
									{
										...
										mysql_query("delete from $table where d_test_id='$page_id'");
								   ...
								   mysql_query("delete from $table where VideoID='$page_id'");
