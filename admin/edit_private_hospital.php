...
<body>
<form method="post" action="edit_private_hospital.php" enctype="multipart/form-data" accept-charset="utf-8">
  <div id="header">
                ...
                <div class="panel-body"> 
                  ...
                  <div>
                    <?php
								 ...
								 {
								   $page_id = $_GET['id'];
								   $query="select * from private_hospital where pri_hs_id =$page_id";
								   ...
								   if ($result->num_rows > 0)
								   {
								       while($row = $result->fetch_assoc())
								       {
										 ...
										 $id = $row['pri_hs_id'];
										 $name = $row['pri_hs_name'];
										 $city = $row['pri_hs_city'];
										 $address=$row['pri_hs_address'];
										 $phone=$row['pri_hs_phone'];
										 $website=$row['pri_hs_website'];
										 
										 $p_image=$row['pri_hs_image'];
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6"> <img src="img/<?php echo $p_image;?>" width="100" height="100" alt="" border="0">
                        <input style="display:none;" type="text" name="pre_image"  class="form-control" id="inputEmail3" value="<?php echo $p_image; ?>">
                      </div>
                    </div>
                    <div class="form-group">
...
if($hosp_name=='' &&  $hosp_city=='' && $hosp_address=='' &&  $hosp_phone==''){
	...
	exit();
       ...
       $uploadfile = $uploaddir . basename($_FILES['image']['name']);
		...
		$update_query = "update private_hospital set pri_hs_name='$hosp_name',pri_hs_city='$hosp_city',pri_hs_address='$hosp_address',
		pri_hs_phone='$hosp_phone', pri_hs_website='$hosp_weblink',pri_hs_image='$post_image' where pri_hs_id = '$pageid'";
		...
		{
		$update_query = "update private_hospital set pri_hs_name='$hosp_name',pri_hs_city='$hosp_city',pri_hs_address='$hosp_address',
		pri_hs_phone='$hosp_phone', pri_hs_website='$hosp_weblink',pri_hs_image='$post_pre_image' where pri_hs_id = '$pageid'";
		mysqli_query($conn,$update_query);
		}
