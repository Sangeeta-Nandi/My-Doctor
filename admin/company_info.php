...
<body>
<form method="post" action="company_info.php" enctype="multipart/form-data" accept-charset="utf-8">
  <div id="header">
          ...
          <div class="row principal_msg"> <!-- Principal Massage Start-->
            <div class="col-md-12">
              <div class="panel panel-primary">
                <div style="font-weight: bold; font-size: 18px; text-align:center;" class="panel-heading">Company Info Entry</div>
                <div class="panel-body"> 
                  ...
                  <div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input name="cname" type="text" class="form-control" id="inputEmail3" placeholder="Enter Company Name">
                      </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <?php  
										...
										$query="select * FROM d_company  order by 1 DESC LIMIT 50";
                    ...
                    <tr>
                      <td><?php echo $name; ?></td>
                      <td><?php echo $type; ?></td>
                      <td><a href="edit_my_doctor.php?id=<?php echo $id; ?>&content=<?php echo $table; ?>">Edit</a></td>
...
if(isset($_POST['submit'])){
	 ...
	 $post_type= $_POST['companytype'];
	 
if($post_cname==''  &&  $post_type==''){
	...
	//	move_uploaded_file($image_tmp,"../news_file/$post_image");
		$insert_query = "insert into d_company(company_id,company_name,	company_type) values ('','$post_cname','$post_type')";
