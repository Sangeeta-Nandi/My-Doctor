...
<body>
<form method="post" action="diagnostic.php" enctype="multipart/form-data" accept-charset="utf-8">
  <div id="header">
          ...
          <div class="row principal_msg"> <!-- Principal Massage Start-->
            <div class="col-md-12">
              <div class="panel panel-primary">
                <div style="font-weight: bold; font-size: 18px; text-align:center;" class="panel-heading">Diagnostic Entry</div>
                <div class="panel-body"> 
                  <!--table-->
                  <div class="row">
                    <div class="form-group">
                      <label for="hname" class="col-sm-4 control-label">Diagnostic Provider Name:</label>
                      <div class="col-sm-6">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table">
							   ...
							   $query="select * FROM diagnostic  order by 1 DESC LIMIT 50";
                                ...
                                <tr>
                                    ...
                                    <td><a href="edit_diagnostic.php?id=<?php echo $id;?>">Edit</a></td>
...
if(isset($_POST['submit'])){
	...
	//	move_uploaded_file($image_tmp,"../news_file/$post_image");
		$insert_query = "insert into diagnostic(id,provider_name,city,address,phone,website) values ('','$post_hname','$post_city','$post_address','$post_phone','$post_hlink')";
		mysqli_query($conn,$insert_query);
	
	if($insert_query !=''){
	
	echo "<script>alert('post inserted successfuly')</script>";
	 echo "<script>window.open('diagnostic.php','_self')</script>";
